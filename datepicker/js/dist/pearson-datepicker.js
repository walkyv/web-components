...
(function (w, doc) {
  ...
  var Datepicker = function (_HTMLElement) {
    ...
    _createClass(Datepicker, [{
      ...
      value: function returnCalendarData() {
        var data = this.returnDateData(),
        ...
        if (name === 'open') {
          if (oldValue !== newValue) {
            if (newValue === 'true') {
              ...
              var calendarTemplate = this.buildCalendar();
