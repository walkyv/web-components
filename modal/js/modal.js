(function(w, doc) {
  ...
  class Modal extends HTMLElement {
    ...
    connectedCallback() {
      ...
      const currentDoc = doc.querySelector('link[href$="modal.html"]')
        .import;
    ...
    renderStyles(parentNode) {
      const elementsVersion = this.hasAttribute('elements'),
        currentDoc = doc.querySelector('link[href$="modal.html"]').import,
        selector = elementsVersion ? '#old' : '#new',
        styleTemplate = currentDoc.querySelector(selector),
        styleClone = doc.importNode(styleTemplate.content, true),
