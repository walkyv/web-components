...
(function (w, doc) {
  ...
  function buildAlert(returnNode, opts) {
    ...
    _createClass(FileUpload, [{
      ...
      value: function handleFiles(files) {
        ...
        if (files.length <= parseInt(this.maxNumberOfFiles)) {
          ...
          modal.appendChild(buildAlert("#attachFiles", alertMessage3));
        }
      }
    }, {
      key: 'deleteFile',
      value: function deleteFile(event) {
        ...
        xhr.addEventListener('load', function () {
          if (xhr.readyState === 4 && xhr.status === 204) {
            ...
            modal.appendChild(buildAlert("#attachFiles2", alertMessage));
          }
        });
