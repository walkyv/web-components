...
(function (w, doc) {
  ...
  template.innerHTML = ' \n    <style>\n    :focus{-webkit-box-shadow:none;box-shadow:none;outline:2px solid #0b73da;outline-offset:4px}*,:after,:before,:host{-webkit-box-sizing:border-box;box-sizing:border-box}:host{font-family:14px,18px,Open Sans,Calibri,Tahoma,sans-serif;background-color:#fff;color:#6a7070}:host-context(.dark){background-color:#005a70;color:#d9d9d9}::slotted(.panels){padding:1em}.tabs-wrapper{position:relative;background-color:inherit}.tabs,ul{list-style-type:none;padding:0;margin:0}.tab,li{display:inline-block}.tab-button{color:inherit;cursor:pointer;display:block;margin:.5em 1em;padding:.5em 0;text-decoration:none;background:none;border:0;border-bottom:3px solid transparent}.tab-button.active{color:#252525}.tab-button:not(.active):hover{color:#252525;border-bottom-color:#c7c7c7}:host-context(.dark) .tab-button.active{color:#fff}:host-context(.dark) .tab-button:not(.active):hover{color:#fff;border-bottom-color:#d9d9d9}.tab-slider{height:3px;background-color:#19a6a4;position:absolute;padding:0;margin:.5em 1em;bottom:-8px;-webkit-transition:all .5s ease-in-out;transition:all .5s ease-in-out}.hidden{display:none}.pe-label{font-size:1rem;line-height:1.28571rem}\n    </style>\n    <div id="tabs-wrapper" class="tabs-wrapper">\n      <slot name="tabs"></slot>\n      <div id="slider" class="tab-slider"></div>\n    </div>\n    <slot name="panels"></slot>\n';
