  ...
  var ButtonBar = function (_HTMLElement) {
    ...
    function ButtonBar() {
      ...
      var clone = template.content.cloneNode(true),
          ...
          slot = slotClone.querySelector('slot'),
