...
(function(w, doc) {
  ...
  template.innerHTML = `
<style>
input{display:block;width:100%;height:36px;padding:0 14px;border:1px solid #c7c7c7;border-radius:2px}input:focus{outline:3px solid #0b73da}ul{list-style-type:none;padding:0;margin:0}svg{fill:currentColor;vertical-align:top}:host,:host *,:host :after,:host :before{-webkit-box-sizing:border-box;box-sizing:border-box;font:14px/18px Open Sans,Calibri,Tahoma,sans-serif}:host{display:inline-block;max-width:400px;color:#252525}.pe-icon-wrapper,.pe-icon-wrapper>*{pointer-events:none}.pe-icon-wrapper{position:absolute;color:#6a7070}.timepicker{position:relative}.timepicker .pe-icon-wrapper{right:14px;top:50%}.timepicker-input{min-width:150px}.timepicker-input[aria-invalid=true]{border-color:#db0020}.timepicker-input[aria-invalid=true]:focus{outline-color:#db0020}.timepicker-input[aria-invalid=true]~.pe-icon-wrapper{top:-webkit-calc(50% - 11px);top:calc(50% - 11px)}.timepicker-input[aria-invalid=true]~.timepicker-error{display:block}.timepicker-error{display:none;color:#db0020;font-size:12px;line-height:16px;margin-top:4px;margin-bottom:2px}.listbox{min-width:220px;width:100%;max-height:300px;border:1px solid #c7c7c7;border-radius:2px;overflow-y:auto}.listbox-item{cursor:pointer;position:relative;padding:4px 24px}.listbox-item.pseudo-focus,.listbox-item:hover{background-color:#e9e9e9}.listbox-item.pseudo-focus{border-radius:4px;-webkit-box-shadow:inset 0 0 0 2px #0b73da;box-shadow:inset 0 0 0 2px #0b73da}.listbox-item .pe-icon-wrapper{display:none;left:5px}.listbox-item[aria-selected=true] .pe-icon-wrapper{display:block}@-webkit-keyframes slideInUp{0%{-webkit-transform:translate3d(0,100%,0);transform:translate3d(0,100%,0);visibility:visible}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@keyframes slideInUp{0%{-webkit-transform:translate3d(0,100%,0);transform:translate3d(0,100%,0);visibility:visible}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@-webkit-keyframes fadeOutUp{0%{opacity:1}to{opacity:0;-webkit-transform:translate3d(0,-100%,0);transform:translate3d(0,-100%,0)}}@keyframes fadeOutUp{0%{opacity:1}to{opacity:0;-webkit-transform:translate3d(0,-100%,0);transform:translate3d(0,-100%,0)}}@-webkit-keyframes fadeIn{0%{opacity:0}to{opacity:1}}@keyframes fadeIn{0%{opacity:0}to{opacity:1}}@-webkit-keyframes fadeOut{0%{opacity:1}to{opacity:0}}@keyframes fadeOut{0%{opacity:1}to{opacity:0}}.animated{-webkit-animation-duration:1s;animation-duration:1s;-webkit-animation-fill-mode:backwards;animation-fill-mode:backwards}@media screen and (prefers-reduced-motion:reduce){.animated{-webkit-animation:unset!important;animation:unset!important}}.animateIn{-webkit-animation-name:fadeIn;animation-name:fadeIn;-webkit-animation-duration:.5s;animation-duration:.5s}@media (max-width:480px){.animateIn{-webkit-animation-name:slideInUp;animation-name:slideInUp}}.animateOut{-webkit-animation-name:fadeOut;animation-name:fadeOut;-webkit-animation-duration:.2s;animation-duration:.2s}@media (max-width:480px){.animateOut{-webkit-animation-name:fadeOutUp;animation-name:fadeOutUp}}
</style>
