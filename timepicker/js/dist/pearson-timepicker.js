...
(function (w, doc) {
  ...
  var TimePicker = function (_HTMLElement) {
    ...
    _createClass(TimePicker, [{
      ...
      get: function get() {
        return ['hours', 'increments', 'selected', 'open', 'valid'];
      }
    }]);
    ...
    _createClass(TimePicker, [{
      ...
      value: function connectedCallback() {
        ...
        console.log(this.hours, this.valid);
