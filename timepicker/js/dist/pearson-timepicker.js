...
(function (w, doc) {
  ...
  function calculate(increment) {
    var endTime = moment().add('h', 24),
        timeStops = [],
        startTime = moment().add('m', increment - moment().minute() % increment);
  ...
  var TimePicker = function (_HTMLElement) {
    ...
    _createClass(TimePicker, [{
      ...
      get: function get() {
        return ['hours', 'increments', 'selected', 'open', 'valid', 'readonly', 'value', 'disabled'];
      }
    }]);
    ...
    _createClass(TimePicker, [{
      ...
      value: function disconnectedCallback() {
        doc.removeEventListener(this.onMouseDown);
      }
    }, {
        ...
        if (name === 'open') {
          ...
          if (isOpen) {
            ...
            if (selectedNode !== null) {
              var selectedIcon = selectedNode.querySelector('.pe-icon-wrapper');
              // selectedNode.scrollIntoView();
              selectedNode.setAttribute('aria-activedescendant', true);
