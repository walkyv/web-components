...
(function (w, doc) {
  ...
  template.innerHTML = '\n<style>\ninput{display:block;width:100%;height:36px;padding:0 14px;border:1px solid #c7c7c7;border-radius:2px;margin-top:6px}input:focus{outline:3px solid #0b73da}ul{list-style-type:none;padding:0;margin:0}svg{fill:currentColor;vertical-align:top}:host,:host *,:host :after,:host :before{-webkit-box-sizing:border-box;box-sizing:border-box;font:14px/18px Open Sans,Calibri,Tahoma,sans-serif}:host{position:relative;display:inline-block;max-width:400px;color:#252525}.pe-icon-wrapper,.pe-icon-wrapper>*{pointer-events:none}.pe-icon-wrapper{position:absolute;color:#6a7070}.timepicker{position:relative}.timepicker .pe-icon-wrapper{right:14px;top:33px}.timepicker-label{font-size:12px;line-height:16px}.timepicker-input{min-width:150px}.timepicker-input[aria-invalid=true]{border-color:#db0020}.timepicker-input[aria-invalid=true]:focus{outline-color:#db0020}.timepicker-input[aria-invalid=true]~.timepicker-error{display:block}.timepicker-error{display:none;font-size:12px;line-height:16px;color:#db0020;margin-top:4px;margin-bottom:2px}.listbox-wrapper{position:absolute;width:100%;background-color:#fff}.listbox{min-width:220px;width:100%;max-height:300px;border:1px solid #c7c7c7;border-radius:2px;overflow-y:auto;visibility:hidden;opacity:0}.listbox-item{cursor:pointer;position:relative;padding:4px 24px}.listbox-item.pseudo-focus,.listbox-item:hover{background-color:#e9e9e9}.listbox-item.pseudo-focus{border-radius:4px;-webkit-box-shadow:inset 0 0 0 2px #0b73da;box-shadow:inset 0 0 0 2px #0b73da}.listbox-item .pe-icon-wrapper{display:none;left:5px}.listbox-item[aria-selected=true] .pe-icon-wrapper{display:block}.hidden{display:none}@-webkit-keyframes slideInUp{0%{-webkit-transform:translate3d(0,100%,0);transform:translate3d(0,100%,0);visibility:visible}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@keyframes slideInUp{0%{-webkit-transform:translate3d(0,100%,0);transform:translate3d(0,100%,0);visibility:visible}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@-webkit-keyframes fadeOutUp{0%{opacity:1}to{opacity:0;-webkit-transform:translate3d(0,-100%,0);transform:translate3d(0,-100%,0)}}@keyframes fadeOutUp{0%{opacity:1}to{opacity:0;-webkit-transform:translate3d(0,-100%,0);transform:translate3d(0,-100%,0)}}@-webkit-keyframes fadeIn{0%{visibility:hidden;opacity:0}to{opacity:1;visibility:visible}}@keyframes fadeIn{0%{visibility:hidden;opacity:0}to{opacity:1;visibility:visible}}@-webkit-keyframes fadeOut{0%{opacity:1;visibility:visible}to{opacity:0;opacity:1}}@keyframes fadeOut{0%{opacity:1;visibility:visible}to{opacity:0;opacity:1}}.animated{-webkit-animation-duration:1s;animation-duration:1s;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}@media screen and (prefers-reduced-motion:reduce){.animated{-webkit-animation:unset!important;animation:unset!important}}.animateIn{-webkit-animation-name:fadeIn;animation-name:fadeIn;-webkit-animation-duration:.5s;animation-duration:.5s}@media (max-width:480px){.animateIn{-webkit-animation-name:slideInUp;animation-name:slideInUp}}.animateOut{-webkit-animation-name:fadeOut;animation-name:fadeOut;-webkit-animation-duration:.2s;animation-duration:.2s}@media (max-width:480px){.animateOut{-webkit-animation-name:fadeOutUp;animation-name:fadeOutUp}}\n</style>\n  <div class="timepicker">\n    <label \n      class="timepicker-label"\n      for="timepicker-input"\n    >\n      Select time (HH:MM AM/PM)\n    </label>\n    <input \n      type="text" \n      id="timepicker-input"\n      class="timepicker-input"\n      role="combobox"\n      aria-haspopup="listbox"\n      aria-expanded="false"\n      aria-owns="listbox"\n      aria-autocomplete="none"\n    >\n    <span class="pe-icon-wrapper">\n      ' + clockIcon + '\n    </span> \n    <p \n      id="timepicker-error"\n      class="timepicker-error"\n    >\n        ' + warningIcon + '\n        Enter a valid time.\n    </p>\n  </div>\n  <div class="listbox-wrapper">\n    <ul\n      id="listbox"\n      class="listbox animated"\n      role="listbox"\n    ></ul>\n  </div>\n';
    ...
    _createClass(Timepicker, [{
      ...
      value: function attributeChangedCallback(name, oldValue, newValue) {
        if (name === 'open') {
          ...
          if (isOpen) {
            this.listbox.classList.remove('animateOut');
            this.listbox.classList.add('animateIn');
          } else {
            this.listbox.classList.remove('animateIn');
            this.listbox.classList.add('animateOut');
          }
        }
      }
    }, {
