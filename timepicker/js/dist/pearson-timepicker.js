    ...
    _createClass(TimePicker, [{
      ...
      value: function onMouseDown(event) {
        ...
        if (nextActiveIdx >= 0) {
          ...
          var isNextVisible = isElementVisible(nextActiveEl, this.list);
          if (!isNextVisible) {
            nextActiveEl.scrollIntoView();
          }
