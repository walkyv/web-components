    ...
    <ul>
      <li>
        ...
        <path d="M16.7357409,12.6772865 L16.735721,12.6772745 C16.7265641,12.6872407 16.7170283,12.6971852 16.7071068,12.7071068 L9.70710678,19.7071068 C9.31658249,20.0976311 8.68341751,20.0976311 8.29289322,19.7071068 C7.90236893,19.3165825 7.90236893,18.6834175 8.29289322,18.2928932 L14.5857864,12 L8.29289322,5.70710678 C7.90236893,5.31658249 7.90236893,4.68341751 8.29289322,4.29289322 C8.68341751,3.90236893 9.31658249,3.90236893 9.70710678,4.29289322 L16.7071068,11.2928932 C17.0878409,11.6736274 17.0973856,12.2849891 16.7357409,12.6772865 Z"  fill-rule="nonzero"></path>
            ...
            <li>
        <button id="login" class="gr-btn header-btn">
          <div class="text">
            <span class="gr-font-large">Log out</span>
            <span class="gr-meta">Sign out of all Pearson products</span>
          </div>
        ...
        <path d="M16.7357409,12.6772865 L16.735721,12.6772745 C16.7265641,12.6872407 16.7170283,12.6971852 16.7071068,12.7071068 L9.70710678,19.7071068 C9.31658249,20.0976311 8.68341751,20.0976311 8.29289322,19.7071068 C7.90236893,19.3165825 7.90236893,18.6834175 8.29289322,18.2928932 L14.5857864,12 L8.29289322,5.70710678 C7.90236893,5.31658249 7.90236893,4.68341751 8.29289322,4.29289322 C8.68341751,3.90236893 9.31658249,3.90236893 9.70710678,4.29289322 L16.7071068,11.2928932 C17.0878409,11.6736274 17.0973856,12.2849891 16.7357409,12.6772865 Z"  fill-rule="nonzero"></path>
                  ...
                  <li>
        <button id="login2" class="gr-btn header-btn">
          <div class="text">
            <span class="gr-font-large">Log out</span>
            <span class="gr-meta">Sign out of all Pearson products</span>
          </div>
...
outline: 1px solid transparent !important;
  ...
  class Header extends HTMLElement {
    ...
    renderMenu () {
      const expandClone = expandIconTemplate.content.cloneNode(true);
      ...
      this.button.addEventListener('click', event => {
        ...
        if (!this.open) {
          ...
          const headerMenu = this.shadowRoot.querySelector('.header-menu'),
            ...
            headerMenu.addEventListener('animationend', event => {
              firstFocusableItem.focus();
            });

            focusableItems.forEach((button, index) => {
              ...
              button.addEventListener('keydown', event => {
                ...
                if (event.key === 'ArrowUp') {
                  ...
                  if (this.shadowRoot.activeElement === firstFocusableItem) {
                ...
                if (event.key === 'ArrowDown') {
                  event.preventDefault();
                  if (this.shadowRoot.activeElement === lastFocusableItem) {
                    firstFocusableItem.focus();
                  } else {
    ...
    renderLoggedIn () {
      const loginButton = this.shadowRoot.querySelector('.gr-header .actions button'),
    ...
    renderLoggedOut () {
      const loginButtonClone = loginButtonTemplate.content.cloneNode(true),
    ...
    connectedCallback() {
      const whiteLogo = whiteLogoTemplate.content.cloneNode(true),
