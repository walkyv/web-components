...
`;
  ...
  overlayTemplate.innerHTML = ` 
    <div id="headerOverlay" class="overlay animateInLight" style="
        position:fixed;
        height:100%;
        width:100%;
